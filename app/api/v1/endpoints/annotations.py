...
async def annotate_dataset(
    ...
    """Trigger Celery-backed auto-annotation for all images in the dataset."""
    ...
    # Dispatch to Celery worker (replaces BackgroundTasks)
    from app.workers.celery_tasks import run_annotation
    run_annotation.delay(job_id=job.id, dataset_id=dataset_id)
